...
$.fn.extend({
	Search(name,tagData){
	    ...
	    $(".fileId").on("click","dl dd",function(){
	    	...
	    	if(id!=undefined){
	    		$(".AD").append('<a href="javascript:;" class="label"><span lay-value="64">'+$(this).html()+'</span><input type="hidden" name="'+name+'" id="'+$(this).html()+'" value="'+id+'"/><i class="layui-icon close">ဆ</i></a>')
	    		$(".AD").parent().show();
